...
import com.tjcloud.tenpay.api.enums.TenpayAppId;
import com.tjcloud.tenpay.api.enums.TenpayMchApiKey;
...
//		appId，partnerId，prepayId，nonceStr，timeStamp，package。注意：package的值格式为Sign=WXPay 
		...
		payJsRequest.setAppid(TenpayAppId.getText(tradeType));
		...
		String paySign = TenpaySignature.generateSign(mapS,TenpayMchApiKey.getText(tradeType));
