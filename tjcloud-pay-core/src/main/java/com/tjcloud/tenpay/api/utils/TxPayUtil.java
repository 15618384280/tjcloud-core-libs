...
import com.tjcloud.tenpay.api.enums.TXTenpayAppId;
import com.tjcloud.tenpay.api.enums.TXTenpayMchApiKey;
...
//		appId，partnerId，prepayId，nonceStr，timeStamp，package。注意：package的值格式为Sign=WXPay 
		...
		payJsRequest.setAppid(TXTenpayAppId.getText(tradeType));
		...
		String paySign = TenpaySignature.generateSign(mapS,TXTenpayMchApiKey.getText(tradeType));
		if(TenpayTradeType.Tenpay_JSAPI.getText().equals(tradeType)){
