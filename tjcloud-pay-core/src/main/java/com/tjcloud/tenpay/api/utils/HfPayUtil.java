...
import com.tjcloud.tenpay.api.enums.HFTenpayAppId;
import com.tjcloud.tenpay.api.enums.HFTenpayMchApiKey;
...
//		appId，partnerId，prepayId，nonceStr，timeStamp，package。注意：package的值格式为Sign=WXPay 
		...
		payJsRequest.setAppid(HFTenpayAppId.getText(tradeType));
		...
		String paySign = TenpaySignature.generateSign(mapS,HFTenpayMchApiKey.getText(tradeType));
